...
namespace OpenUtau.Core.Ustx {
    ...
    public class UProject {
        ...
        public string[] expSelectors = new string[] { Format.Ustx.CLR, Format.Ustx.PITD, Format.Ustx.DYN, Format.Ustx.ENG, Format.Ustx.VEL, Format.Ustx.VOL, Format.Ustx.ATK, Format.Ustx.DEC, Format.Ustx.GEN, Format.Ustx.BRE };
